...
const Disputes = () => {
  ...
  const disputeStats = [
    { value: "0", label: "Open Disputes", icon: AlertCircle, color: "text-accent" },
    { value: "0", label: "Under Review", icon: Clock, color: "text-primary" },
    { value: "0", label: "Resolved", icon: CheckCircle2, color: "text-green-500" },
    { value: "0", label: "Total Tickets", icon: FileText, color: "text-purple-500" },
  ];
          ...
          {navItems.map((item, index) => (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-foreground hover:bg-primary/10 hover:text-primary transition-all duration-200 hover:translate-x-1 group animate-fade-in ${
                item.href === "/disputes" ? "bg-primary/10 text-primary" : ""
              }`}
        ...
        <div className="p-6">
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Manage disputes and get help from our Trust & Safety team
                  </p>
                </div>
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[525px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Describe your issue and our Trust & Safety team will assist you
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectItem value="trade">Trade Dispute</SelectItem>
                            <SelectItem value="payment">Payment Issue</SelectItem>
                            <SelectItem value="scam">Report Scam</SelectItem>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="orderId">Order/Trade ID (Optional)</Label>
                        <Input id="orderId" placeholder="Enter related order or trade ID" />
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1fr,380px] gap-6">
            ...
            <div className="space-y-6">
              ...
              <Card className="shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-12 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Disputes or Tickets</h3>
                  <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                    You don't have any open support tickets or disputes. If you need assistance or encounter an issue, our Trust & Safety team is here to help.
                  </p>
                  ...
                  <div className="bg-primary/5 border border-primary/10 rounded-lg p-6 text-left">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h4 className="font-semibold text-primary">When to Contact Support:</h4>
                    </div>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-0.5">•</span>
                        <span>Issues with trades or transactions</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-0.5">•</span>
                        <span>Report suspicious activity or scams</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-0.5">•</span>
                        <span>Payment or account problems</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-primary mt-0.5">•</span>
                        <span>Questions about platform policies</span>
                      </li>
                    </ul>
                  </div>
                </CardContent>
            ...
            <div className="space-y-6">
              ...
              <Card className="shadow-lg hover:shadow-xl transition-all duration-300 border-primary/20 animate-fade-in" style={{ animationDelay: '100ms' }}>
                <CardHeader>
                ...
                <CardContent className="space-y-3">
                  <p className="text-sm text-muted-foreground">
                    Our team is available 24/7 to help resolve issues and maintain a safe trading environment.
                  </p>
                  <Separator />
                  <div className="space-y-2">
                    <Button variant="outline" className="w-full gap-2 justify-start hover:border-primary/50">
                      <MessageSquare className="h-4 w-4" />
                      Live Chat
                    </Button>
                    <Button variant="outline" className="w-full gap-2 justify-start hover:border-primary/50">
              ...
              {/* Live Activity */}
              <Card className="shadow-lg hover:shadow-xl transition-all duration-300 border-accent/20 animate-fade-in" style={{ animationDelay: '200ms' }}>
                <CardHeader>
                  <CardTitle className="text-sm flex items-center gap-2">
