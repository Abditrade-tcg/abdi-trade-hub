...
const MyCollection = () => {
  ...
  const collectionStats = [
    { value: "0", label: "Total Cards", icon: BookMarked, color: "text-primary" },
    { value: "$0", label: "Estimated Value", icon: DollarSign, color: "text-green-500" },
    { value: "0", label: "Unique Cards", icon: Sparkles, color: "text-purple-500" },
  ];

  const proTips = [
    "Use high-quality photos for better value estimates",
    "Keep track of card conditions for accurate pricing",
    "Import large collections using our CSV template",
    "Set price alerts for cards you're watching",
  ];
              ...
              <div className="flex items-start justify-between">
                <div>
                  <CardTitle className="text-2xl mb-2 flex items-center gap-2">
                    <BookMarked className="h-6 w-6 text-primary animate-pulse" />
                    My Collection
                  </CardTitle>
                  <p className="text-muted-foreground">
                    Manage and track your card collection
                  </p>
                </div>
              ...
              <Card className="shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                    Add cards to your collection to track their value, organize your inventory, and create listings for trading.
                  </p>
                  ...
                  {/* Pro Tips Section */}
                  <div className="bg-accent/5 border border-accent/10 rounded-lg p-6 text-left">
