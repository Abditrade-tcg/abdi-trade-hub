                  ...
                  <Card className="shadow-lg hover:shadow-xl transition-all duration-300 border-accent/20">
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        ...
                        <Button variant="outline" className="gap-2 hover:border-accent/50">
                          <Plus className="h-4 w-4" />
                          Add Payout Method
                        </Button>
                      </div>
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">
                        Add a bank account or payment service to receive your earnings
                      </p>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="text-xs text-muted-foreground">
                            ...
                            <ul className="space-y-1">
                              <li>• Verify your payout method to enable withdrawals</li>
                              <li>• Bank transfers typically take 1-3 business days</li>
                              <li>• Instant payouts may incur additional fees</li>
                            </ul>
                          </div>
                        </div>
                      </div>
