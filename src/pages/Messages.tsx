          ...
          {navItems.map((item, index) => (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-foreground hover:bg-primary/10 hover:text-primary transition-all duration-200 hover:translate-x-1 group animate-fade-in ${
                item.href === "/messages" ? "bg-primary/10 text-primary" : ""
              }`}
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-6">
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Chat with buyers, sellers, and trading partners
                  </p>
                </div>
              </div>
            </CardHeader>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1fr,380px] gap-6">
            {/* Main Messaging Area */}
            <Card className="shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in h-[calc(100vh-320px)]">
                  ...
                  <div className="flex-1 flex items-center justify-center p-6">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Start trading to begin messaging
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex-1 flex items-center justify-center p-12">
                    <div className="text-center max-w-md">
                      ...
                      <p className="text-muted-foreground mb-6">
                        Choose a conversation from the list or start a new one by trading with other users.
                      </p>
