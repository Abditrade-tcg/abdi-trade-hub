...
const Trades = () => {
  ...
  const tradeStats = [
    { value: "0", label: "Active Trades", icon: RefreshCw, color: "text-primary" },
    { value: "0", label: "Pending Response", icon: Clock, color: "text-accent" },
    { value: "0", label: "Completed", icon: CheckCircle2, color: "text-green-500" },
    { value: "0", label: "Disputes", icon: AlertTriangle, color: "text-red-500" },
  ];
              ...
              <div className="flex items-start justify-between">
                <div>
                  <CardTitle className="text-2xl mb-2 flex items-center gap-2">
                    ...
                    Manage your trades and negotiate deals
                  </CardTitle>
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        type="search"
                        placeholder="Search trades by user, card, or status..."
                        className="pl-10 bg-secondary/50 border-border/50 focus:border-primary/50 focus:ring-primary/20 transition-all"
                      />
                    </div>
