...
const Orders = () => {
  ...
  const orderStats = [
    { value: "0", label: "Pending", icon: Clock, color: "text-accent" },
    { value: "0", label: "Shipped", icon: Truck, color: "text-primary" },
    { value: "0", label: "Delivered", icon: CheckCircle2, color: "text-green-500" },
    { value: "0", label: "Total Orders", icon: ShoppingCart, color: "text-purple-500" },
  ];

  const gettingStartedTips = [
    "Browse thousands of verified card listings",
